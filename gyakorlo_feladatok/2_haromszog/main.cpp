...
int main() {
    ...
    // Paraméterek:
    // 1. Vertex attribútum azonosítója (a vertex shadernek megadtuk, hogy location = 0, tehát 0 lesz)
    // 2. Méret (itt a vertex shader 3 hosszú vektort kap)
    // 3. Típus
    // 4. Normalizált-e
    // 5. Lépésköz 2 vertex adatai között (3 floatnyi)
