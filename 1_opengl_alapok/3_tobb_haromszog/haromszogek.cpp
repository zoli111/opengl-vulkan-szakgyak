...
int main() {
    ...
    // haromszogek pontjai
    // ha vannak kozos pontjai a haromszogeknek, akkor sporolhatunk azon, hogy nem vesszuk oket tobbszor
    float vertices[] = {
        -0.5, -0.5, 0.0,
        -0.5, 0.5, 0.0,
        0.5, -0.5, 0.0,
    ...
    // ezzel mondjuk meg, hogy melyik haromszoghoz melyik pontok tartozzanak
